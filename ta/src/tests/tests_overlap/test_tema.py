...
from ...overlap.tema import tema_numba, tema_talib, tema_ind, tema_polars
from ...overlap.ema import _ema_numba_opt
...
def test_tema_with_nan(prices_with_nan):
    """NaN input poisons TEMA from that point onward (ignore)."""  # noqa: D403, E501
