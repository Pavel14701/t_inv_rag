...
from ta.src.overlap.supertrend import (
    supertrend_ind,
    supertrend_numba,
    supertrend_polars,
    supertrend_talib,
...
@pytest.mark.overlap
def test_supertrend_numba_runs(df_ohlc: pl.DataFrame) -> None:
...
@pytest.mark.overlap
def test_supertrend_long_short_exclusive(df_ohlc: pl.DataFrame) -> None:
...
def test_supertrend_matches_manual_recomputation(
    ...
    from ta.src.volatility import atr_ind
...
@pytest.mark.overlap
def test_supertrend_non_contiguous_and_readonly(df_ohlc: pl.DataFrame) -> None:
