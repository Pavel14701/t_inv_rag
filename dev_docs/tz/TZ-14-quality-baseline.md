...
> **Статус: ⬜ не начат — СТАРТОВАЯ ТОЧКА (выполняется ДО TZ-02).**
> «Нулевой этап» по решению от текущей итерации: сначала разгребаем технический долг,
> потом добавляем фичи.
