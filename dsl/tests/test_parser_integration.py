...
from dsl.exceptions import EvaluationError, ParseError
...
def test_ast_let_shadowing():
    ...
    from dsl.ast import Comparison, Let, LogicalBinOp, Number, Var
...
def test_ast_indicator_with_arithmetic_params():
    ...
    from dsl.ast import Add, IndicatorWithParams, Number
...
def test_ast_rising_with_params():
    ...
    from dsl.ast import IndicatorWithParams, Rising
...
def test_ast_multi_comparison_with_identifiers():
    ...
    from dsl.ast import IndicatorAccess, MultiComparison
...
def test_ast_precedence_with_parentheses():
    ...
    from dsl.ast import Add, Mul, Number
